...
tblLibros = $('#tblLibros').DataTable({
    ajax: {
        ...
        error: function (xhr, error, code) {
            console.error("Erro ao carregar os dados dos livros:", xhr, code);
        }
    },
    columns: [
        { 'data': 'id' },
        ...
        { 'data': 'cantidad' },
        { 'data': 'autor' },
        { 'data': 'materia' }, // Certifique-se de que o campo "materia" é retornado corretamente
        { 'data': 'editorial' },
        { 'data': 'foto' },
        { 'data': 'descripcion' },
        { 'data': 'estado' },
...
tblPrestar = $('#tblPrestar').DataTable({
    ajax: {
        ...
        dataSrc: '',
        error: function (xhr, error, code) {
            console.error("Erro ao carregar os dados dos empréstimos:", xhr, code);
        }
    },
    columns: [
        { 'data': 'id' },
...
//Fin Estudiante
function frmMateria() {
    document.getElementById("title").textContent = "Nova materia";
    document.getElementById("btnAccion").textContent = "Cadastrar";
